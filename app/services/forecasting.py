...
from app.services.model_definition import load_model
...
class ForecastEngine:
    ...
    def forecast_next(self):
        ...
        try:
            ...
            tensor_input = torch.tensor(sequence_scaled, dtype=torch.float32).unsqueeze(
                0
            )
...
forecast_engine = ForecastEngine(
    preload_buffer=_env_flag("FORECAST_PRELOAD_BUFFER", False)
)
